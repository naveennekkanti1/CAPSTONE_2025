...
# -------------------------------------
@app.route('/admin_dashboard/form_builder/<form_id>', methods=['GET', 'POST'])
@admin_required
...
@app.route('/admin_dashboard/create_form')
@admin_required
...
@app.route('/admin_dashboard/delete_form/<form_id>', methods=['POST'])
@admin_required
...
# -------------------------------------
@app.route('/admin_dashboard/form_submissions/<form_id>')
@admin_required
...
# -------------------------------------
@app.route('/admin_dashboard/send_email', methods=['GET', 'POST'])
@admin_required
...
@app.route('/admin_dashboard/forms')
@admin_required
def admin_form_list():
...
@app.route('/admin_dashboard/send_notification_email', methods=['GET', 'POST'])
def send_general_notification_email():
    if not ('user_id' in session and session.get('role') == 'admin'):
        flash("Unauthorized access.", "danger")
        return redirect(url_for('login'))
    ...
    if request.method == 'POST':
        ...
        if not (recipient_email and recipient_name and subject and message_body):
            flash("Please fill out all required fields.", "warning")
            return redirect(url_for('send_general_notification_email'))
        ...
        msg.html = render_template(
            "general_notification.html",   # this is for the email the *user* receives
    ...
    # Admin sees this form. Users do not.
